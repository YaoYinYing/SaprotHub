...
def get_subcellular_model():
    ...
    seqs = dispatcher.parse_data(
        ...
        "https://raw.githubusercontent.com/westlake-repl/SaprotHub/main/upload_files/%5BEXAMPLE%5D%5BAminoAcidClassification-3Categories%5DMultiple_AA_Sequences.csv",
    )
