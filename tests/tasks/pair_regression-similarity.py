...
import torch
from saprot.utils.data_preprocess import InputDataDispatcher, StructuralAwareSequencePair
...
def get_thermol_model():
    ...
    seqs: tuple[StructuralAwareSequencePair]=dispatcher.parse_data("Multiple_pairs_of_PDB/CIF_Structures", 'upload_files/[EXAMPLE]Multiple_pairs_of_PDB_Structures.csv')
